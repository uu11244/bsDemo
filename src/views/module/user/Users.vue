  ...
  <div class="users-container">
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="5">
          <el-button type="primary" plain style="heigth:40px" @click="addUserBtn">添加</el-button>
        </el-col>
      </el-row>
    ...
    <!-- 添加/修改用户的弹窗 -->
    <userDialog v-if="visible" :visible.sync="visible" :dialogTitle="dialogTitle" :editId="editId"></userDialog>
